...
const HomeBody: React.FC = () => {
    ...
    const postMsg = async () => {
        let flag2 = false;
        const response = await api.put('/v1/ts/cards/' + inputCodigo, {
            "nome_card": inputNome,
    ...
    return (
        <>
            ...
            <body id='CriarUserBody'>
                ...
                <h2 id='TitleBar'>Atualizar de Card</h2>
                <ul id='UserUl'>
                    <div id='UserForm'>
                        <div id='divH1'>
                            <h1>Id*: </h1>
                        ...
                        <div id='divInput'>
                            ...
                            <input type="text" value={inputImageLink} onChange={e => setInputImageLink(e.target.value)} required />
                            <input type="text" value={inputThumbnail} onChange={e => setInputThumbnail(e.target.value)} required />
                            <input type="text" value={inputFolderId} onChange={e => setInputFolderId(e.target.value)} required />
                        </div>
                    </div>
